...
from inference_face_test import infer_face #import file du doan anh tu onnx
...
def main():
    path_onnx = '/home/maicg/Documents/python-image-processing/code-edit-insightFace/onnx/ImageClassifier.onnx'
    import glob
                ...
                if kpss is not None:
                    ...
                    if area_crop < area_base:
                        ...
                        if area_crop == 0:
                            ...
                            cv2.imwrite('./demo/test_onnx_CNN/rj/frame{0}_nho.jpg'.format(k), crop_img)
                    else:
                        result_onnx = infer_face(path_onnx, crop_img)
                        if result_onnx == 1:
                            cv2.imwrite('./demo/test_onnx_CNN/cr/frame{0}.jpg'.format(k), crop_img)
                        else:
                            cv2.imwrite('./demo/test_onnx_CNN/er/frame{0}.jpg'.format(k), crop_img)
