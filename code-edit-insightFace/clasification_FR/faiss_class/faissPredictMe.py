...
def main():
    ...
    path = '/home/maicg/Documents/python-image-processing/code-edit-insightFace/clasification_FR/faiss_class/dataMe/dataDemo'
    path_dir = '/home/maicg/Documents/python-image-processing/code-edit-insightFace/clasification_FR/faiss_class/dataMe/dataTest'
    k=0
    if cap.isOpened():
        while True:
            for i in range(4):
            ...
            if img_detect is not None:
                ...
                result = computeEmb(img_detect, net=net)
