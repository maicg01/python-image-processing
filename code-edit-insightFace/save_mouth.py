...
def xyz_coordinates(kps):
    ...
    return distance12, distance_nose1, distance_nose2, distance_center_eye_mouth, distance_nose_ceye, distance_nose_cmouth, distance_eye, distance_mouth, l_eye, r_eye, l_mouth, r_mouth

def save_mouth(img, l_mouth, r_mouth, dir_save):
    l_mouth_x = l_mouth[0]+20; l_mouth_y = l_mouth[1]+20
    r_mouth_x = r_mouth[0]-20; r_mouth_y = r_mouth[1]-20
    img_crop = img[l_mouth_y:r_mouth_y,l_mouth_x:r_mouth_x]
    f_name = dir_save + '/img' + str(l_mouth[0]) + '.jpg'
    cv2.imwrite(f_name, img_crop)
...
def main():
    dir_save_mouth = "/home/maicg/Documents/python-image-processing/code-edit-insightFace/data/mouth"
    import glob
    ...
    cap = cv2.VideoCapture('/home/maicg/Documents/test-face-recognition/data_video/trua/10_01_2023/cam2.avi')
        ...
        while True:
            ...
            for i in range(bboxes.shape[0]):
                ...
                if kpss is not None:
                    ...
                    #     kp = kp.astype(np.int)
                    #     cv2.circle(img, tuple(kp) , 1, (0,0,255) , 2)
                    distance12, distance_nose1, distance_nose2, distance_center_eye_mouth, distance_nose_ceye, distance_nose_cmouth, distance_eye, distance_mouth, l_eye, r_eye, l_mouth, r_mouth = xyz_coordinates(kps)
                    ...
                    if area_crop == 0:
                        ...
                        if distance12 >= distance_nose1 and distance12 >= distance_nose2:
                            if distance_center_eye_mouth >= distance_nose_ceye and distance_center_eye_mouth >= distance_nose_cmouth:
                                save_mouth(img,l_mouth, r_mouth, dir_save_mouth)
