...
def main():
    ...
    path_dir = '/home/maicg/Documents/python-image-processing/code-edit-insightFace/quality-image/test_quality'
    k=0
    if cap.isOpened():
        while True:
            # for i in range(4):
            ...
            for i in range(bboxes.shape[0]):
                ...
                if kpss is not None:
                    ...
                    if area_crop == 0:
                        ...
                        try:
                            quality, emb = take_image(BACKBONE, QUALITY, DEVICE, rotate_img)
                        except:
                            continue
                        print(emb.shape)
