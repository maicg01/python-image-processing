...
def main():
    cap = cv2.VideoCapture('/home/devai01/Me/python-image-processing/people_check.mp4')
    pTime = 0
    ...
    while True:
        ...
        # cv2.imwrite("/home/devai01/Me/python-image-processing/results/landmark/landmark-mediapipe.jpg", img)
        cv2.imshow("Test", img)
