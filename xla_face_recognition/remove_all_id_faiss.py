...
def rm_id(id):
    ...
    for i in range(len(face_collection_ids)):
        ...
        if face_collection_ids[i] == id:
            ...
            print("face_collection_ids delete item of", id)
            index_to_delete.append(i)
    # delete index
    face_collection_embedded.remove_ids(np.array(index_to_delete))
    face_collection_ids = np.delete(face_collection_ids, index_to_delete)
