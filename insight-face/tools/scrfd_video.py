...
if __name__ == '__main__':
    ...
    detector = SCRFD(model_file='/home/maicg/Documents/python-image-processing/insight-face/onnx/scrfd_10g.onnx')
    detector.prepare(-1)
    # img_paths = ['/home/maicg/Documents/python-image-processing/insight-face/tests/data/t4.jpg']
    cap = cv2.VideoCapture('/home/maicg/Documents/python-image-processing/insight-face/tests/people_check.mp4')
    while True:
        result, img = cap.read()
